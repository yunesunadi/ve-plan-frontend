...
export const MOD_ORGANIZER_ROUTES: Routes = [
  ...
  },
  {
    ...
    resolve: { event: eventResolver },
    data: { requireOwner: true, breadcrumb: [MY_EVENTS_CRUMB, EVENT_TITLE_CRUMB, 'Registered Users'] },
  },
  {
    path: "events/:id/invite",
    component: InviteComponent,
    resolve: { event: eventResolver },
    data: { requireOwner: true, breadcrumb: [MY_EVENTS_CRUMB, EVENT_TITLE_CRUMB, 'Invite Users'] },
  },
  {
    ...
    children: [
      {
        ...
        resolve: { event: eventResolver },
        data: { requireOwner: true, breadcrumb: [MY_EVENTS_CRUMB, EVENT_TITLE_CRUMB, MEETING_CRUMB] },
      },
      {
        path: "attendees",
        component: EventAttendeesComponent,
        resolve: { event: eventResolver },
        data: { requireOwner: true, breadcrumb: [MY_EVENTS_CRUMB, EVENT_TITLE_CRUMB, MEETING_CRUMB, 'Attendees'] },
      },
    ],
  },
  {
